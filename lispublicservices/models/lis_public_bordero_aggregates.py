...
class LISPublicBorderoAggregates(object):

    """Implementation of the 'LISPublicBorderoAggregates' model.

    The LISPulbicBorderoAggregates. The LISPulbicBorderoAggregates are
    readonly.
    ...
    def __init__(self,
        ...
        """Constructor for the LISPublicBorderoAggregates class"""
