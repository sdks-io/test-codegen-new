...
class LISPublicTransportSectionBase(object):

    """Implementation of the 'LISPublicTransportSectionBase' model.

    The LISTransportSectionEntityBase is the base class for the two derived
    classes LISPublicTransportSectionBordero and
    LISPublicTransportSectionShipment. These classes are described in the list
    of public services structures on the left side.

    Attributes:
        transport_section_type (string): Gets or sets the TranportSectionType
        bordero_id (int): Gets or sets the TranportSectionType
    ...
    def __init__(self,
        ...
        """Constructor for the LISPublicTransportSectionBase class"""
    ...
    def from_dictionary(cls,
        ...
        return cls(transport_section_type,
                   bordero_id,
                   company_id,
                   division_id,
                   department_id,
