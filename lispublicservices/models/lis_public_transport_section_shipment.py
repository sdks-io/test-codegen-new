...
class LISPublicTransportSectionShipment(object):

    """Implementation of the 'LISPublicTransportSectionShipment' model.
    ...
    def __init__(self,
        ...
        """Constructor for the LISPublicTransportSectionShipment class"""
