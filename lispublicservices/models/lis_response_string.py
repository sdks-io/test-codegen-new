...
class LISResponseString(object):

    """Implementation of the 'LISResponse[String]' model.

    The api response class.

    Attributes:
        operation_result (string): The operation result.
    ...
    def __init__(self,
        ...
        """Constructor for the LISResponseString class"""
