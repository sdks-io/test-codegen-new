...
class ScanningController(BaseController):

    """A Controller to access Endpoints in the lispublicservices API."""
    def __init__(self, config):
        super(ScanningController, self).__init__(config)

    def move_sscc_to_hd_place(self,
                              scan_request):
        """Does a POST request to /Scanning/MoveSSCC.

        TODO: type endpoint description here.

        Args:
            scan_request (LISPublicScanRequest): TODO: type description here.
